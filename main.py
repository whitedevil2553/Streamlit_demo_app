...
model.load_state_dict(torch.load("CNN_BrainMRI_tumor_classification.pt", map_location=device))
model.eval()
...
single_image_path = st.file_uploader("Choose an image...", type=["jpg", "jpeg", "png"])
