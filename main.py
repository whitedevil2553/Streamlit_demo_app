...
with st.sidebar:
    selected = option_menu('Multiple Brain Disease Prediction System',
                           ['Brain Tumor Detection','Alzhimer Detection'],
...
if selected=="Alzhimer Detection":
    ...
    if single_image_path_2 is not None:
        ...
        if(result_button_2):
            if prediction==0:
                st.success("Based on the MRI Scanned Image the patient don't have any kind of Alzhimer")
            elif prediction==1:
                st.error("Based on the MRI Scanned Image the patient do have a MildDemented Alzhimer")
            elif prediction==2:
                st.error("Based on the MRI Scanned Image the patient do have a Moderate-Demented Alzhimer")
            elif prediction==3:
                st.success("Based on the MRI Scanned Image the patient do have a Very-MildDemented Alzhimer")
    else:
        st.info("Import the valid MRI Scanned image of brain witout any unwanted weights occurs!...")
